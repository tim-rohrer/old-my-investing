...
import companyProfiles, { fetchFMPCompanyProfileBySymbol, companyProfileFMPAdded } from './companyProfilesSlice'
    ...
    describe('Reducer', () => {
        ...
        describe('extraReducers: fetchFMPCompanyProfileBySymbol', () => {
            it('should handle a pending request', () => {
                ...
                const actual = functions.companyProfilesSlice.reducer(<any>testState, testAction)
            ...
            it('should handle fulfilled promise response ', () => { 
                ...
                const testAction = fetchFMPCompanyProfileBySymbol.fulfilled(mockFMPCompanyProfileApple,'','AAPL')
                // console.log(action)
                const actual = functions.companyProfilesSlice.reducer(<any>testState, testAction)
